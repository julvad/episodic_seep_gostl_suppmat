...
* oil_seep_rate.ipynb: Notebook to calculate the oil emission rates
* pred.ipynb: Notebook to predict missing surface current speed data from the IML-10 buoy (predicted data in data/current_speed_pred)
* data/wind_current_iml10.csv: IML-10 buoy data (wind and current speed and direction, wave height, wave period, air pressure and more)
